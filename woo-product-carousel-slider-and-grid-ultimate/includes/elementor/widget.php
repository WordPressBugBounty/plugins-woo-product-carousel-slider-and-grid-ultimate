...
class Elementor_Woo_Ultimate_Widget extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		$atts = array(
			...
			'nav_back_color'                => isset( $settings['nav_back_color'] ) && $settings['nav_back_color'] ? $settings['nav_back_color'] : '#f7f7fa',
			'nav_border_color'              => isset( $settings['nav_border_color'] ) && $settings['nav_border_color'] ? $settings['nav_border_color'] : '#f7f7fa',
			...
			'title_font_color'        		=> isset( $settings['title_font_color'] ) && $settings['title_font_color'] ? $settings['title_font_color'] : '#363940',
			'title_hover_font_color'        => isset( $settings['title_hover_font_color'] ) && $settings['title_hover_font_color'] ? $settings['title_hover_font_color'] : '#ff5500',
			'price_font_color'        		=> isset( $settings['price_font_color'] ) && $settings['price_font_color'] ? $settings['price_font_color'] : '#363940',
			...
			'cart_font_color'        		=> isset( $settings['cart_font_color'] ) && $settings['cart_font_color'] ? $settings['cart_font_color'] : '#ffffff',
			'action_icon_font_color'        => isset( $settings['action_icon_font_color'] ) && $settings['action_icon_font_color'] ? $settings['action_icon_font_color'] : '#ff5500',
			'action_icon_hover_color'       => isset( $settings['action_icon_hover_color'] ) && $settings['action_icon_hover_color'] ? $settings['action_icon_hover_color'] : '#ff5500',
